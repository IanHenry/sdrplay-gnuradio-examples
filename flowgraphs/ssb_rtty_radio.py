...
class ssb_rtty_radio(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SSB RTTY Radio", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SSB RTTY Radio")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ssb_rtty_radio")
        ...
        self.filename_input = filename_input = 'capture.iq'
        ...
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.freq_xlating_filter = filter.freq_xlating_fir_filter_ccc(4, firdes.low_pass(1,samp_rate, 0.3e3, 0.25e3), 0, samp_rate)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.freq_xlating_filter.set_taps(firdes.low_pass(1,self.samp_rate, 0.3e3, 0.25e3))
...
def main(top_block_cls=ssb_rtty_radio, options=None):
