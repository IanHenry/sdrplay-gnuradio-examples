...
class rtty(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "rtty")
        ...
        # Variables
        ##################################################
        self.freq_khz = freq_khz = 14090
        self.samp_rate = samp_rate = 250000
        self.record_toggle = record_toggle = 0
        self.freq_correction = freq_correction = 0
        self.filename_input = filename_input = 'rtty_capture.iq'
...
def main(top_block_cls=rtty, options=None):
