...
class broadcast_am(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "broadcast_am")
        ...
        # Variables
        ##################################################
        self.freq_khz = freq_khz = 909
        self.samp_rate = samp_rate = 250000
        self.record_toggle = record_toggle = 0
        self.freqcor = freqcor = 0
        self.filename_input = filename_input = 'broadcast_am_capture.iq'
        ...
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, firdes.low_pass(1,samp_rate, 15e3, 8e3), 0, samp_rate)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.freq_xlating_fir_filter_xxx_0.set_taps(firdes.low_pass(1,self.samp_rate, 15e3, 8e3))
...
def main(top_block_cls=broadcast_am, options=None):
