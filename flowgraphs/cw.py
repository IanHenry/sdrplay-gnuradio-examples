...
class cw(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "cw")
        ...
        self.filename_input = filename_input = 'cw_capture.iq'
        ...
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.freq_xlating_filter = filter.freq_xlating_fir_filter_ccc(4, firdes.low_pass(1,samp_rate, 0.5e3, 0.1e3), 0, samp_rate)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.freq_xlating_filter.set_taps(firdes.low_pass(1,self.samp_rate, 0.5e3, 0.1e3))
