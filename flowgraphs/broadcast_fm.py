...
class broadcast_fm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "broadcast_fm")
        ...
        # Variables
        ##################################################
        self.freq_khz = freq_khz = 100700
        self.samp_rate = samp_rate = 1000000
        self.record_toggle = record_toggle = 0
        self.freqcor = freqcor = 0
        self.filename_input = filename_input = 'broadcast_fm_capture.iq'
        ...
        self.qtgui_const_sink_x_0.set_y_axis((-0.8), 0.8)
        self.qtgui_const_sink_x_0.set_x_axis((-0.8), 0.8)
        ...
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(5, firdes.low_pass(1, samp_rate, 192e3, 100e3), 0, samp_rate)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.freq_xlating_fir_filter_xxx_0.set_taps(firdes.low_pass(1, self.samp_rate, 192e3, 100e3))
...
def main(top_block_cls=broadcast_fm, options=None):
